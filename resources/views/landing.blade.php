    ...
    <head>
        ...
        <style>
            ...
            *::after {
            ...
            .btn-yellow {
                background: var(--classen-yellow);
                color: var(--classen-dark)
            }

            .btn-yellow:hover {
                background: var(--classen-yellow-hover);
                transform: translateY(-2px);
                box-shadow: 0 12px 32px rgba(255, 209, 0, .35)
            }

            .btn-dark {
                background: var(--classen-dark);
                color: #fff
            }
            ...
            .btn-green {
                background: var(--classen-green);
                color: #fff
            }

            .btn-green:hover {
                background: var(--classen-green-dark);
                transform: translateY(-2px)
            }
            ...
            .trust-card {
                ...
                border-radius: var(--radius);
                box-shadow: var(--shadow-xl);
                border-left: 4px solid var(--classen-yellow);
            }
            ...
            .product-block.stock {
                background: linear-gradient(135deg, #1a3a08 0%, #2d5a15 100%);
                color: #fff
            }
            ...
            .product-type:hover .product-type-img img {
            ...
            .colors-header .section-label::before {
                display: none
            }

            .colors-header .section-subtitle {
                margin: 0 auto
            }
            ...
            .color-group h3 {
                ...
                margin-bottom: 24px;
                padding-bottom: 12px;
                border-bottom: 2px solid var(--classen-yellow);
                display: inline-block;
            }
            ...
            .b2b-feature:hover {
                background: rgba(255, 255, 255, .07);
                border-color: rgba(255, 209, 0, .15)
            }
            ...
            .official-badge {
                ...
                border-radius: var(--radius);
                box-shadow: var(--shadow-md);
                border: 1px solid var(--classen-border);
            }
            ...
            .official-badge-divider {
                width: 1px;
                height: 32px;
                background: var(--classen-border)
            }
            ...
            .official-badge-dark img {
                height: 32px;
                filter: brightness(0) invert(1)
            }

            .official-badge-dark .official-badge-divider {
                background: rgba(255, 255, 255, .15)
            }

            .official-badge-dark .official-badge-text {
                color: rgba(255, 255, 255, .5)
            }

            .official-badge-dark .official-badge-text strong {
                color: #fff
            }
            ...
            .classen-partner-strip {
                ...
                gap: 20px;
                padding: 20px 0;
                background: var(--classen-warm);
                border-top: 1px solid var(--classen-border);
                border-bottom: 1px solid var(--classen-border);
            }

            .classen-partner-strip img {
                height: 28px;
                opacity: .7
            }

            .classen-partner-strip span {
                font-size: .78rem;
                font-weight: 600;
                color: var(--classen-muted);
                letter-spacing: .5px
    ...
    <body>
            ...
            <div class="container hero-content">
                <div class="hero-grid">
                    <div class="hero-text">
                        ...
                        <p>Fedezze fel Magyarország egyik legszélesebb Classen kínálatát. Az összes kollekció,
                        ...
                        <div class="trust-features">
                            <div class="trust-feature">
                                ...
                                <div>
                                    ...
                                    <p>Közvetlen gyártói kapcsolat és hivatalos disztribúciós megállapodás. Minden
                            ...
                            <div class="trust-feature">
                                ...
                                <div>
                                    ...
                                    <p>Hozzáférünk a Classen teljes, aktuális katalógusához – lakkozott, CPL, keretes és
                            ...
                            <div class="trust-feature">
                                ...
                                <div>
                                    ...
                                    <p>Több mint 20 év tapasztalat nyílászárók terén. Szakértő tanácsadás az
        ...
        <section class="collections" id="kollekcio">
            <div class="container">
                <div class="collections-header animate">
                    ...
                    <p class="section-subtitle">A Classen folyamatosan bővíti kínálatát a legújabb trendeknek
                ...
                <div class="collections-grid">
                    <a href="https://arcadia98.hu/kollekciok/Evelin" target="_blank" class="collection-card animate">
                        ...
                        <div class="collection-card-body">
                            ...
                            <span class="collection-card-link">Felfedezés <svg viewBox="0 0 24 24" fill="none"
                    ...
                    <a href="https://arcadia98.hu/kollekciok/Mamba" target="_blank"
                        class="collection-card animate animate-delay-1">
                        <div class="collection-card-img">
                    ...
                    <a href="https://arcadia98.hu/kollekciok/Malika" target="_blank"
                        class="collection-card animate animate-delay-2">
                        <div class="collection-card-img">
                    ...
                    <a href="https://arcadia98.hu/kollekciok/Tumula" target="_blank"
                        class="collection-card animate animate-delay-3">
                        <div class="collection-card-img">
            ...
            <div class="container">
                <div class="products-split">
                    <div class="product-block stock animate">
                        ...
                        <p>Sürgős a felújítás? Kiemelt raktárkészlettel rendelkezünk a legnépszerűbb CPL és dekorfóliás
                    ...
                    <div class="product-block all animate animate-delay-1">
                        ...
                        <p>A modern minimáltól a klasszikus eleganciáig. Lakkozott, keretes, CPL felületű és tolóajtó
        ...
        <section class="colors" id="szinek">
            <div class="container">
                <div class="colors-header animate">
                    ...
                    <p class="section-subtitle">Négy felülettípus – Primo, 3D Look, Iridium és CPL – összesen több mint
                ...
                <div class="color-groups animate">
                    ...
                    <div class="color-group">
                        ...
                        <div class="color-swatches">
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#f5f5f0"></div><span
                                    class="color-swatch-name">Fehér</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#d4c49a"></div><span
                                    class="color-swatch-name">Akác</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#c8a86e"></div><span
                                    class="color-swatch-name">Natur tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#b89c6a"></div><span
                                    class="color-swatch-name">Lengyel tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#5c3a1e"></div><span
                                    class="color-swatch-name">Dió</span>
                            </div>
                        </div>
                    </div>
                    <!-- 3D LOOK -->
                    <div class="color-group">
                        ...
                        <div class="color-swatches">
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#b99a6e"></div><span
                                    class="color-swatch-name">Riviéra tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#e8dcc8"></div><span
                                    class="color-swatch-name">Fehér kőris</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#c4a67a"></div><span
                                    class="color-swatch-name">Sonoma tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#8a6e4a"></div><span
                                    class="color-swatch-name">Kolumbia dió</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#a08050"></div><span
                                    class="color-swatch-name">Olajos tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#8e8378"></div><span
                                    class="color-swatch-name">Szürke tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#9a7c5a"></div><span
                                    class="color-swatch-name">Catania tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#4a4440"></div><span
                                    class="color-swatch-name">Antracit tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#c09040"></div><span
                                    class="color-swatch-name">Méz tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#7a6048"></div><span
                                    class="color-swatch-name">Cleveland tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box new" style="background:#9e7e58"></div><span
                                    class="color-swatch-name">Tocantis tölgy</span>
                            </div>
                        </div>
                    </div>
                    <!-- IRIDIUM -->
                    <div class="color-group">
                        ...
                        <div class="color-swatches">
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#eeebe5"></div><span
                                    class="color-swatch-name">Fehér matt</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#f0ece0"></div><span
                                    class="color-swatch-name">Hófehér kőris</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#a09080"></div><span
                                    class="color-swatch-name">Barna kőris</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#5a5550"></div><span
                                    class="color-swatch-name">Grafit kőris</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#6e4830"></div><span
                                    class="color-swatch-name">Marone tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#3a2a1a"></div><span
                                    class="color-swatch-name">Wenge</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#1a1a1a"></div><span
                                    class="color-swatch-name">UNI Black</span>
                            </div>
                        </div>
                    </div>
                    <!-- CPL -->
                    <div class="color-group">
                        ...
                        <div class="color-swatches">
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#b09878"></div><span
                                    class="color-swatch-name">Hamilton tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#c8b898"></div><span
                                    class="color-swatch-name">Világos akác</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#a09080"></div><span
                                    class="color-swatch-name">Norvég kőris</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box stock" style="background:#f2f0ec"></div><span
                                    class="color-swatch-name">Fehér RAL 9003</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box new"
                                ...
                                </div><span class="color-swatch-name">Fehér struktúrált</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#8a7050"></div><span
                                    class="color-swatch-name">Antik tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#5a3820"></div><span
                                    class="color-swatch-name">Olasz dió</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#555048"></div><span
                                    class="color-swatch-name">Grafit tölgy</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#c8baa8"></div><span
                                    class="color-swatch-name">Kasmír</span>
                            </div>
                            <div class="color-swatch">
                                <div class="color-swatch-box" style="background:#4a4a48"></div><span
                                    class="color-swatch-name">Grafit RAL 7024</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="cta-section">
            <div class="container cta-inner animate">
                ...
                <p class="cta-description">Ezen az oldalon a márka bemutatását látja. A webshopunkban minden részletet
                    megtalál:</p>
        ...
        <section class="why" id="miert">
            <div class="container">
                <div class="why-header animate">
                    ...
                    <p class="section-subtitle">A Classen több mint 30 éve az európai beltéri ajtópiac meghatározó
                        szereplője.</p>
                </div>
                <div class="why-grid">
                    <div class="why-card animate">
                        ...
                        <h3>Design</h3>
                        <p>Nemzetközi trendeknek megfelelő, díjnyertes formatervezés. Minden stílushoz – a modern
                    ...
                    <div class="why-card animate animate-delay-1">
                        ...
                        <h3>Tartósság</h3>
                        <p>Hard Edge R profil és karcálló felületek (Primo, Iridium, CPL). Akár a legnagyobb
                    ...
                    <div class="why-card animate animate-delay-2">
                        ...
                        <h3>Innováció</h3>
                        <p>Szabadalmaztatott megoldások és környezetbarát gyártás. A legmodernebb technológiával
                            készülnek.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="b2b-grid">
                    <div class="b2b-text animate">
                        <img src="{{ Vite::asset('resources/images/CLASSEN-Group.png') }}" alt="Classen"
                            style="height:30px;margin-bottom:20px;filter:brightness(0) invert(1);opacity:.7">
                        <div class="section-label">B2B Partnerprogram</div>
                        <h2 class="section-title">Legyen partnerünk!</h2>
                        <p>Asztalosoknak, kivitelezőknek és viszonteladóknak exkluzív partneri feltételeket kínálunk.
        ...
        <div class="footer-cta">
            <div class="container footer-cta-inner">
                <div style="margin-bottom:20px"><img src="{{ Vite::asset('resources/images/CLASSEN-Group.png') }}"
                        alt="Classen" style="height:36px;margin:0 auto"></div>
                ...
                <div class="footer-cta-buttons">
                    ...
                    <a href="#kapcsolat" class="btn btn-lg"
                        style="background:var(--classen-dark);color:var(--classen-yellow);border:2px solid var(--classen-dark)">Kapcsolatfelvétel</a>
                </div>
            </div>
        </div>
        ...
        <footer class="site-footer">
            <div class="container footer-inner">
                ...
                <div class="footer-logo">
                    <img src="{{ Vite::asset('resources/images/CLASSEN-Group.png') }}" alt="Classen"
                        style="height:32px;opacity:.6;filter:brightness(0) invert(1)">
                </div>
            </div>
        </footer>
